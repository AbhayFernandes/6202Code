...
public class Drivetrain extends Subsystem {
    ...
    public void arcadeDrive(Joystick stick) {
        ...
        differentialDrive1.arcadeDrive(xSpeed, ySpeed);// RobotBuilder Version: 2.0
//
// This file was generated by RobotBuilder. It contains sections of
// code that are automatically generated and assigned by robotbuilder.
// These sections will be updated in the future when you export to
...
public class Drivetrain extends Subsystem {
    ...
    public void arcadeDrive(Joystick stick, Compressor Compressor) {
    ...
    public void topDrive(Joystick stick) {
        double xSpeed = stick.getX();
        double ySpeed = stick.getY();
        double zSpeed = stick.getZ();  
    }
