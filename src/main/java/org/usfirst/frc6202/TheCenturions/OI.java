...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.toggleWhenPressed(new HatchOff());
        joystickButton2.toggleWhenPressed(new CargoOut());
        joystickButton3.whenPressed(new CargoIn());
        joystickButton4.whenPressed(new WoodDown());
        joystickButton7.whenPressed(new CargoUp());
        joystickButton8.whenPressed(new CargoDown());
